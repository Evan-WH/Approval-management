package com.examine.process.controller;
...
import com.examine.process.domain.ExamineProcess;
import com.examine.process.service.IExamineProcessService;
...
public class ExamineProcessController extends BaseController
{
     ...
     * 查询访客申请列表
     */
    @PreAuthorize("@ss.hasPermi('process:show:list')")
    @GetMapping("/list")
     ...
     * 导出访客申请列表
     */
    @PreAuthorize("@ss.hasPermi('process:show:export')")
     ...
     * 获取访客申请详细信息
     */
    @PreAuthorize("@ss.hasPermi('process:show:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增访客申请
     */
    @PreAuthorize("@ss.hasPermi('process:show:add')")
     ...
     * 修改访客申请
     */
    @PreAuthorize("@ss.hasPermi('process:show:edit')")
     ...
     * 删除访客申请
     */
    @PreAuthorize("@ss.hasPermi('process:show:remove')")
